...
const NAV_LINKS = [
    ...
    { label: "About", href: "https://github.com/about", target: "_blank" },
];
...
const Navbar = () => {
    ...
    return (
        <nav className="sticky top-0 z-50 bg-[#161b22]/95 backdrop-blur-md
                    border-b border-[#30363d]/80 shadow-lg shadow-black/30">

            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-14">
                    <div className="flex items-center gap-2.5">
                        <span className="text-[#8b949e] hover:text-white transition-colors duration-200">
                            <GitHubIcon />
                        </span>

                        <span className="bg-gradient-to-r from-white to-[#388bfd]
                             bg-clip-text text-transparent
                             text-base font-semibold tracking-wide select-none">
                    ...
                    <button
                        ...
                        className="sm:hidden text-[#8b949e] hover:text-white hover:bg-white/5
                       p-2 rounded-md active:scale-95
                       transition-all duration-200
                       focus:outline-none focus:ring-2 focus:ring-[#388bfd]/60"
                    >
            ...
            {mobileMenuOpen && (
                <div className="sm:hidden border-t border-[#30363d]/60 px-4 pb-4 pt-2 space-y-1">
                    {NAV_LINKS.map((link) => (
                        <a
                            key={link.label}
                            href={link.href}
